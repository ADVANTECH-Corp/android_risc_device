...
include device/fsl/rsb_4411_a1/build_id.mk
...
TARGET_RECOVERY_FSTAB = device/fsl/rsb_4411_a1/fstab_sd.freescale
# build for ext4
PRODUCT_COPY_FILES +=	\
	device/fsl/rsb_4411_a1/fstab_sd.freescale:root/fstab.freescale
else
TARGET_RECOVERY_FSTAB = device/fsl/rsb_4411_a1/fstab_sd-f2fs.freescale
# build for f2fs
PRODUCT_COPY_FILES +=	\
	device/fsl/rsb_4411_a1/fstab_sd-f2fs.freescale:root/fstab.freescale
...
# build for f2fs
PRODUCT_COPY_FILES +=	\
	device/fsl/rsb_4411_a1/fstab-f2fs.freescale:root/fstab.freescale
endif # BUILD_TARGET_FS
endif # BUILD_TARGET_DEVICE


TARGET_BOOTLOADER_BOARD_NAME := RSB-4411-A1
...
UBI_ROOT_INI := device/fsl/rsb_4411_a1/ubi/ubinize.ini
...
TARGET_BOOTLOADER_CONFIG := imx6q:mx6qrsb4411a1android_1G_defconfig
TARGET_BOARD_DTS_CONFIG := imx6q:imx6q-rsb4411-a1.dtb
TARGET_KERNEL_DEFCONF := imx_v7_adv_android_defconfig

BOARD_SEPOLICY_DIRS := \
       device/fsl/imx6/sepolicy \
       device/fsl/rsb_4411_a1/sepolicy

BOARD_SECCOMP_POLICY += device/fsl/rsb_4411_a1/seccomp
