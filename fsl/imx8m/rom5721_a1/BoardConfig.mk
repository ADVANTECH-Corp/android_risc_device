...
IMX_DEVICE_PATH := device/fsl/imx8m/rom5721_a1
...
TARGET_BOOTLOADER_BOARD_NAME := rom5721_a1

PRODUCT_MODEL := rom5721_a1
...
BOARD_PREBUILT_DTBOIMAGE := out/target/product/rom5721_a1/dtbo-imx8mm.img
ifeq ($(PRODUCT_IMX_TRUSTY),true)
...
#TARGET_BOARD_DTS_CONFIG ?= imx8mm:adv-imx8mm-android-rom5721-a1-dsi2lvds-m101nwwb.dtb
TARGET_BOARD_DTS_CONFIG ?= imx8mm:adv-imx8mm-android-rom5721-a1-dsi2lvds-g070vw01.dtb
# u-boot target for imx8mm_evk with LPDDR4 on board
ifeq ($(LOW_MEMORY),true)
TARGET_BOOTLOADER_CONFIG := imx8mm:imx8mm_evk_1g_ddr_android_defconfig
else
TARGET_BOOTLOADER_CONFIG := imx8mm:imx8mm_rom5721a1_2G_android_defconfig
endif
...
TARGET_BOOTLOADER_CONFIG += imx8mm-evk-uuu:imx8mm_rom5721a1_2G_android_uuu_defconfig
