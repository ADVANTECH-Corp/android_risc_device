...
IMX_DEVICE_PATH := device/fsl/imx8m/rom5720_a1
...
TARGET_BOOTLOADER_BOARD_NAME := rom5720_a1

PRODUCT_MODEL := rom5720_a1
...
BOARD_PREBUILT_DTBOIMAGE := out/target/product/rom5720_a1/dtbo-imx8mq.img
# imx8mq with HDMI display
TARGET_BOARD_DTS_CONFIG ?= imx8mq:adv-imx8mq-rom5720-a1-dual-display.dtb
...
#TARGET_BOARD_DTS_CONFIG += imx8mq-dual:adv-imx8mq-rom5720-a1-dual-display.dtb
