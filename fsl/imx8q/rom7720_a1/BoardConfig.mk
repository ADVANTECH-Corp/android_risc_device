...
IMX_DEVICE_PATH := device/fsl/imx8q/rom7720_a1
...
TARGET_BOOTLOADER_BOARD_NAME := rom7720_a1

PRODUCT_MODEL := rom7720_a1
...
BOARD_KERNEL_CMDLINE := init=/init androidboot.hardware=freescale androidboot.fbTileSupport=enable cma=800M@0x960M-0xe00M androidboot.primary_display=imx-drm firmware_class.path=/vendor/firmware transparent_hugepage=never loop.max_part=7 androidboot.selinux=permissive
...
BOARD_PREBUILT_DTBOIMAGE := out/target/product/rom7720_a1/dtbo-imx8qm.img
ifeq ($(PRODUCT_IMX_CAR),true)
AB_OTA_PARTITIONS += bootloader
BOARD_OTA_BOOTLOADERIMAGE := out/target/product/rom7720_a1/bootloader-imx8qm.img
ifeq ($(PRODUCT_IMX_CAR_M4),true)
# imx8qm auto android
...
TARGET_BOARD_DTS_CONFIG := imx8qm:adv-imx8qm-rom7720-a1.dtb
# imx8qm standard android; MIPI panel display
TARGET_BOARD_DTS_CONFIG += imx8qm-mipi-panel:adv-imx8qm-rom7720-a1_lvds0.dtb
# imx8qm standard android; HDMI display
TARGET_BOARD_DTS_CONFIG += imx8qm-hdmi:adv-imx8qm-rom7720-a1_hdmi_lvds0.dtb
...
TARGET_BOOTLOADER_CONFIG := imx8qm:imx8qm_rom7720a1_4G_android_defconfig
...
TARGET_BOOTLOADER_CONFIG += imx8qm-mek-uuu:imx8qm_rom7720a1_4G_android_uuu_defconfig
...
TARGET_KERNEL_DEFCONFIG := rom7720_android_defconfig
