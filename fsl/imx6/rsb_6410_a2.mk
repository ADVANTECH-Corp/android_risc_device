...
ifneq ($(wildcard device/fsl/rsb_6410_a2/fstab_nand.freescale),)
$(shell touch device/fsl/rsb_6410_a2/fstab_nand.freescale)
endif

ifneq ($(wildcard device/fsl/rsb_6410_a2/fstab.freescale),)
$(shell touch device/fsl/rsb_6410_a2/fstab.freescale)
endif

# Overrides
PRODUCT_NAME := rsb_6410_a2
PRODUCT_DEVICE := rsb_6410_a2
...
DEVICE_PACKAGE_OVERLAYS := device/fsl/rsb_6410_a2/overlay
...
PRODUCT_COPY_FILES += \
	...
	device/fsl/rsb_6410_a2/required_hardware.xml:system/etc/permissions/required_hardware.xml
