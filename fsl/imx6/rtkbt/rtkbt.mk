...
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/conf/rtkbt.conf:/system/etc/bluetooth/rtkbt.conf
...
$(call inherit-product-if-exists, $(LOCAL_PATH)/firmware/usb/rtl8723d/device-rtl.mk)
$(call inherit-product-if-exists, $(LOCAL_PATH)/firmware/usb/rtl8821c/device-rtl.mk)
